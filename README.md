...
[![Deploy](https://github.com/c9py/webvm-zero/actions/workflows/deploy.yml/badge.svg)](https://github.com/c9py/webvm-zero/actions/workflows/deploy.yml)

**WebVM-Zero** is a browser-based Linux virtual machine powered by [CheerpX](https://leaningtech.com/cheerpx/) with [Agent Zero](https://github.com/frdel/agent-zero) AI agent framework integrated.

Based on [WebVM](https://webvm.io) - a Linux virtual machine that runs in your browser.

## Key Features

- **Browser-Based Linux VM**: Run a full Debian-based Linux environment directly in your browser
- **AI Agent Integration**: Agent Zero framework pre-installed for AI-powered task automation  
- **No Server Required**: Everything runs client-side using WebAssembly
- **Networking Support**: Connect via Tailscale VPN for network access
...
WebVM is powered by the CheerpX virtualization engine, enabling safe, sandboxed client-side execution of x86 binaries on any browser. 

## Table of Contents

- [Agent Zero Integration](#agent-zero-integration)
- [Fork, deploy, customize](#fork-deploy-customize)
- [Running WebVM locally](#run-webvm-locally-with-a-custom-debian-mini-disk-image)
...
Agent Zero is a personal, organic agentic AI framework that grows and learns with you. Once inside the WebVM terminal:
...
- **General-purpose AI Assistant**: Dynamic, learning AI agent
- **Computer as a Tool**: Uses the OS to accomplish tasks
- **Multi-agent Cooperation**: Hierarchical agent delegation
...
|------------|-------------|
| `dockerfiles/debian_mini` | Minimal Debian environment |
| `dockerfiles/debian_large` | Full Debian with more packages |
| `dockerfiles/agent_zero` | Debian with Agent Zero pre-installed |
...
- [CheerpX](https://cheerpx.io/) virtualization engine
- xterm.js, [https://xtermjs.org/](https://xtermjs.org/), for the Web-based terminal emulator
